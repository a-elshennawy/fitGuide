  ...
  useEffect(() => {
    const fetchMetricsAndGoal = async () => {
      ...
      try {
        ...
        // https://myfirtguide.runasp.net/api/UserMetrics/GetAllUserMetrices to view stored metrics
        const [metricsRes, goalRes] = await Promise.all([
          ...
          // https://myfirtguide.runasp.net/api/Goal/GetUserGoal to view stored goal
